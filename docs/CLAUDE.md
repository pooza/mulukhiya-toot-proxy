...
- #4329 feat: AnnictService の GraphQL エラーをカテゴリ別 status code で返す（5.22 Y5 送り、size:S）
- #4330 feat: POST /annict/record に冪等性を持たせて重複 record 投稿を防ぐ（5.22 Y6 送り、size:M）
- #4332 feat: SwSubscriptionContract の allowed_hosts 空配列を deny-all に反転（5.22 G1 送り、運用変更要、size:S）
