...
**2026-09-06 時点で 12 件（closed 6 / open 5 ＋ 実装完了 1）**。#4675 / #4663 / #4680 が後から加わっている。
⚠ **09-06 夜に open PR 3 本（#4673 / #4676 / #4674）をマージした**ので、**残る実装は #4649 だけ**。
...
| #4649 (M) | webhook で落ちた添付を送信側へ返す（#4633 の残り） | 🔵 **5.36.0 に残る唯一の未着手実装**（2026-09-06 時点） |
