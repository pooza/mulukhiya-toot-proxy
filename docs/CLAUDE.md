...
| Issue | 状態 | 主眼 |
| --- | --- | --- |
| #4632 | 未着手 | `/media` のページ送りが境界で 1 件飛ばす |
| #4633 | 未着手 | webhook の添付が黙って落ちる 2 件 |
| #4630 | 未着手 | ログの秘匿の穴 2 件（例外メッセージ内の URL / blocks・attachments） |
| #4629 | 未着手 | 番組表編集 4 本のクライアント起因 403/404 が `e.alert` |
