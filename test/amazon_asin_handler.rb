module MulukhiyaTootProxy
  class AmazonASINHandlerTest < Test::Unit::TestCase
    def test_exec
      ...
      if Config.instance['/amazon/affiliate']
        ...
        assert_equal(handler.summary, 'AmazonASINHandler,1')
        ...
        assert_equal(handler.summary, 'AmazonASINHandler,3')
        ...
        assert_equal(handler.summary, 'AmazonASINHandler,4')
      else
