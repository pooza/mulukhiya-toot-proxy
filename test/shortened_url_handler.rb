module MulukhiyaTootProxy
  class ShortenedURLHandlerTest < Test::Unit::TestCase
    def test_exec
      ...
      assert_equal(handler.summary, 'ShortenedURLHandler,0')

      assert_equal(handler.exec({'status' => 'キュアスタ！ https://goo.gl/uJJKpV'})['status'], 'キュアスタ！ https://precure.ml/')
      assert_equal(handler.summary, 'ShortenedURLHandler,1')
      ...
      assert_equal(handler.summary, 'ShortenedURLHandler,3')
      ...
      assert_equal(handler.summary, 'ShortenedURLHandler,4')
